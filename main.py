'''
python main.py --dataset mnist --gan_type infoGAN --epoch 25 --batch_size 64
'''
...
from abstract_generative_model import Trainable
...
def main():
    ...
    # open session
    Trainables = [GAN, CGAN, infoGAN, ACGAN, EBGAN, WGAN, WGAN_GP, DRAGAN,
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        for Trainable in Trainables:
            if args.gan_type == Trainable.model_name:
                gan = Trainable(sess,
                            epoch=args.epoch,
